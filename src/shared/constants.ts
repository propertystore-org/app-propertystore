...
export const SEND_EMAIL_RESET_PASSWORD  = 'https://propertystore.co.za/api/api/email/email-reset-password-link.php';
export const SEND_EMAIL_ACTIVATE_ACCOUNT = 'https://propertystore.co.za/api/api/email/email-welcome-activate-account.php';
export const SEND_EMAIL_GENERAL_TEXT = 'https://propertystore.co.za/api/api/email/general-email.php';
export const SEND_EMAIL_BILLING = 'https://propertystore.co.za/api/api/email/email-billing.php';
